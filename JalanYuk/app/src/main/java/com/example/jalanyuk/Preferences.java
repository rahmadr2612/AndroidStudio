...
public class Preferences {
    static final String KEY_USER_TEREGISTER ="user", KEY_PASS_TEREGISTER ="pass",KEY_NAME_TEREGISTER = "namalengkap";
    static final String KEY_NAME_SEDANG_LOGIN = "Namalengkap_logged_in";
    static final String KEY_USERNAME_SEDANG_LOGIN = "Username_logged_in";
    static final String KEY_STATUS_SEDANG_LOGIN = "Status_logged_in";
    private static SharedPreferences getSharedPreference(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context);
    }
    public static void setRegisteredNama(Context context, String namalengkap) {
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_NAME_TEREGISTER, namalengkap);
        editor.apply();
    }
    ...
    public static void setLoggedInNama(Context context, String namalengkap){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_NAME_SEDANG_LOGIN, namalengkap);
        editor.apply();
    }
    public static String getLoggedInNama(Context context){
        return getSharedPreference(context).getString(KEY_NAME_SEDANG_LOGIN,"");
    }
    ...
    public static void clearLoggedInUser (Context context){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.remove(KEY_NAME_SEDANG_LOGIN);
